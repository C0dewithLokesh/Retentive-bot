...
const Reliving = () => {
  return (
    <div className="pending-leaves leave-page w-full font-medium font-[Inter]">
      <p>You can track your process here</p>
      <div className="leave-reasons flex center flex-col gap-[10px] px-1 pb-2">
        <div className="reason flex items-center gap-[10px] p-[10px] text-base border-2 w-full rounded-lg bg-white relative">
          <div className="reason-number px-1 py-[6px] bg-[#a7f0a7e6] text-black flex flex-col items-center justify-center rounded-lg text-lg font-bold w-[60px] text-center leading-snug">
          ...
          <div className="reason-content font-normal font-[Inter] flex flex-col items-start justify-start">
            ...
            <div>
              ...
              <span className="text-[14px]">Registration letter is approved & has been sent</span>
            </div>
          </div>
        ...
        <div className="reason flex items-center gap-[10px] p-[8px] text-base border-2 w-full rounded-lg bg-white relative">
          <div className="reason-number px-1 py-[6px] bg-[#FFCD1C33] text-black flex flex-col items-center justify-center rounded-lg text-lg font-bold w-[60px] text-center leading-snug">
            <span className="text-[14px] font-normal font-[Inter]">May</span>
            <span className="text-[20px]">08</span>
            <span className="text-[14px] font-normal font-[Inter]">2022</span>
          </div>
          ...
          <div className="reason-content font-normal font-[Inter] flex flex-col items-start justify-start">
            ...
            <div>
              ...
              <span className="text-[14px]">Letter of acceptance is in progress to you</span>
            </div>
          </div>
        ...
        <div className="reason flex items-center gap-[10px] p-[10px] text-base border-2 w-full rounded-lg bg-white relative">
          <div className="reason-number px-1 py-[6px] bg-[#f33b1233] text-black flex flex-col items-center justify-center rounded-lg text-lg font-bold w-[60px] text-center leading-snug">
            <span className="text-[14px] font-normal font-[Inter]">May</span>
            <span className="text-[20px]">08</span>
            <span className="text-[14px] font-normal font-[Inter]">2022</span>
          </div>
          ...
          <div className="reason-content font-normal font-[Inter] flex flex-col items-start justify-start">
            ...
            <div>
              ...
              <span className="text-[14px]">Relieving letter not processed still</span>
            </div>
          </div>
